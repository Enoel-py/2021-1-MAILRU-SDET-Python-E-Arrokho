...
class BasePageLocators:
    # Login
    MAIN_LOGIN_LOCATOR = (By.XPATH, '//div[@class="responseHead-module-button-1BMAy4" and contains(text(),"Войти")]')  # Кнопка "ВОЙТИ"
    EMAIL_INPUT = (By.XPATH, '//input[@name="email"]')  # Поле для ввода email
